        ...
        <section className="bg-primary-d flex-1 flex items-center justify-center">
            <div className="w-full max-w-6xl sm:px-16 px-6 text-center sm:pt-8 pb-8 sm:pb-16 flex flex-col items-center justify-center gap-6">
                ...
                <motion.div
                    ...
                    className="relative z-10 w-32 h-44 sm:w-56 sm:h-72 -mt-64 sm:-mt-12 overflow-hidden cursor-grab active:cursor-grabbing"
                >
                    <img
                ...
                <p className="text-sm sm:text-base font-semibold tracking-wide uppercase mt-36 sm:mt-2 cursor-default">
